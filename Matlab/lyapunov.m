...
%
%    https://uk.mathworks.com/matlabcentral/fileexchange/4628-calculation-lyapunov-exponents-for-ode
%
%
...
gsc=cum; znorm=cum;
Lexp=zeros(nit,1); % Added MRN

% Initial values
y(1:n)=ystart(:);
for i=1:n1
    y((n1+1)*i)=1.0; % MRN: Perturbations seem to correspond to diagonals of (Jac*Y)
end
t=tstart;
...
for ITERLYAP=1:nit
  ...
  t=t+stept;
  y=Y(size(Y,1),:); % MRN: This is y at the end of this integration step
  for i=1:n1 
      for j=1:n1
          y0(n1*i+j)=y(n1*j+i);
      end
